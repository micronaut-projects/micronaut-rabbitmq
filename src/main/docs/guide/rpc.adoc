...
include::{includedir}configurationProperties/io.micronaut.rabbitmq.connect.SingleRabbitConnectionFactoryConfig$DefaultRpcConfiguration.adoc[]
include::{includedir}configurationProperties/io.micronaut.rabbitmq.connect.ClusterRabbitConnectionFactoryConfig$DefaultRpcConfiguration.adoc[]
