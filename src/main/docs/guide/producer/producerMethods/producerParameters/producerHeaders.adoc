...
It is also possible to pass 'RabbitHeaders' object as method argument to pass a Map of Headers dynamically.
...
<4> A key/value map of headers can be set with the 'RabbitHeaders' object.