...
# (RabbitAnnotatedArgumentBinder.getAnnotationType()); the Python annotation function itself is not accepted
# ("Cannot convert '<function DeliveryTag>' to Java type 'java.lang.Class'")
...
# tag::clazz[]
@Singleton  # <1>
class DeliveryTagAnnotationBinder(RabbitAnnotatedArgumentBinder):  # <2>
