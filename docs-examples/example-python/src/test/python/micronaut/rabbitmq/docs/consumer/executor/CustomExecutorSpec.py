...
@MicronautTest(environments=["rabbitmq"], rebuildContext=True)
...
# tag::producer[]
        self.product_client.send(b"custom-executor-test")
# end::producer[]

        Await.until(lambda: self.product_listener.message_lengths == ["custom-executor-test"])
