...
/**
 * Unchecked exception thrown to indicate that the connection is still down.
 *
...
class TemporarilyDownRuntimeException extends IllegalStateException implements TemporarilyDownException {
    ...
    TemporarilyDownRuntimeException(TemporarilyDownConnection connection, Throwable cause) {
